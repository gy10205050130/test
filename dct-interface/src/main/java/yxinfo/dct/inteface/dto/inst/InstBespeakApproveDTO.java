...
import yxinfo.dct.inteface.dto.chem.apply.ApplyApvDTO;
...
public class InstBespeakApproveDTO extends BaseDTO {
    ...
    // 审核节点信息
    private List<ApplyApvDTO> approveNodes;
    ...
    public List<ApplyApvDTO> getApproveNodes() {
        return approveNodes;
    }

    public void setApproveNodes(List<ApplyApvDTO> approveNodes) {
