...
public class ApproveExecDTO extends BaseDTO {
     ...
     * 审核项目编号
     */
    @Length( max = 10, message = ErrorCode.APPROVE_ITEM_NO_NOT_EMPTY )
     ...
     * 名称
     */
    @Length( max = 255, message = ErrorCode.APPROVE_EXEC_NAME_LENGTH )
     ...
     * 备注
     */
    @Length( max = 255, message = ErrorCode.APPROVE_EXEC_REMARK_LENGTH )
    private String remark;

    /**
     * 过程类型（1流模式, 2自由模式）
     */
    @Length( max = 1, message = ErrorCode.APPROVE_EXEC_TYPE_LENGTH )
