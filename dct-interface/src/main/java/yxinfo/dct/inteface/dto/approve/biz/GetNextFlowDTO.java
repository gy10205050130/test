...
public class GetNextFlowDTO extends BaseDTO {
     ...
     * 审核方案id
     */
    @NotNull( groups = Select.class, message = ErrorCode.APPROVE_EXEC_ID_NOT_EMPTY )
    private Integer approveExecId;

    /**
     * 审核记录id
     */
    @NotNull( groups = Select.class, message = ErrorCode.APPROVE_RECODE_ID_NOT_EMPTY )
    private Integer approveRecodeId;

    /**
     * 审核项目编号
     */
    @Length( max = 10, groups = Add.class, message = ErrorCode.APPROVE_ITEM_NO_LENGTH )
