...
public class WarnRuleDTO extends BaseDTO {
     ...
     * 预警事物标识
     */
    @Length(max = 200, message = ErrorCode.WARN_WARNFOR_LENGTH)
    private String warnFor;
    ...
    public WarnRuleDTO(Integer id, Integer orgId, String itemNo, String warnFor, ChemChemicalDTO chemChemicalDTO, String limitLeft, String limitRight, Integer memberId, Date createAt, String text, String extend1, String extend1Name, String extend2, String extend2Name, String extend3, String extend3Name, String flag) {
        this.id = id;
        this.orgId = orgId;
        this.itemNo = itemNo;
    ...
    public String getWarnFor() {
        return warnFor;
    }

    public void setWarnFor(String warnFor) {
        this.warnFor = warnFor;
    }
