...
public class ChemTrajDTO extends BaseDTO {
    ...
    // 第二负责人
    private MemberDTO inChargeSecMember;
    ...
    public MemberDTO getInChargeSecMember() {
        return inChargeSecMember;
    }

    public void setInChargeSecMember( MemberDTO inChargeSecMember ) {
        this.inChargeSecMember = inChargeSecMember;
    }
}