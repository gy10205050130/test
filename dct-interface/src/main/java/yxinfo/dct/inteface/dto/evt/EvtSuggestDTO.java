...
public class EvtSuggestDTO extends BaseDTO {
    ...
    // 内容
    @NotEmpty( groups = Add.class, message = ErrorCode.EVT_SUGGEST_CONTEXT_NOT_EMPTY )
    @Length( groups = Add.class, max = 2000, message = ErrorCode.EVT_SUGGEST_CONTEXT_LENGTH )
    ...
    // 类型（1APP）
    @NotEmpty( groups = Add.class, message = ErrorCode.EVT_SUGGEST_TYPE_NOT_EMPTY )
