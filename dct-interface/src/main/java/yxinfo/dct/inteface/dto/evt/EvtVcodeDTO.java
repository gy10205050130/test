...
public class EvtVcodeDTO extends BaseDTO {
    ...
    // 用于的功能码
    @NotEmpty( groups = { Add.class, Select.class }, message = ErrorCode.EVT_VCODE_USE_AT_NOT_EMPTY )
    private String useAt;

    // 验证码
    @NotEmpty( groups = { Add.class, Select.class }, message = ErrorCode.EVT_VCODE_CODE_NOT_EMPTY )
    private String fcode;

    // 手机号
    @NotEmpty( groups = { Add.class, Select.class }, message = ErrorCode.EVT_VCODE_MOBILE_NOT_EMPTY )
