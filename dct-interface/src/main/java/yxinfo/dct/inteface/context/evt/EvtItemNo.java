...
public interface EvtItemNo {
     ...
     * 询价单审核
     */
    String WAIT_APPROVE_EQRY = "100021";

    /**
     * 同意/驳回询价单
     */
    String EQRY_PASS_OR_NOT = "100022";

    /**
     * 大仪共享中支付或退款
     */
    String LIS_ORDER_PAYMENT = "100023";

    /**
     * 仪器预约待审核
     */
    String WAIT_APV_INSTRESER = "100024";

    /**
     * 同意或驳回审核
     */
    String INSTRESERAPV_PASS_OR_NOT = "100025";
}
