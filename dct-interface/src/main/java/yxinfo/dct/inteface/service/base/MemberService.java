...
public interface MemberService {
     ...
     *         验证不通过时, {@link ErrorCode.CAN_NOT_REGISTER}
     *         用户已经注册时, {@link ErrorCode.USER_EXIST}
     */
     ...
     * @return
     * @throws DctException, code如下:
     *         ticket失效时, {@link ErrorCode.USER_REGISTER_MUST_VCODE}
     *         验证不通过时, {@link ErrorCode.CAN_NOT_REGISTER}
     *         用户已经注册时, {@link ErrorCode.USER_EXIST}
     */
     ...
     * @param terminal 终端设备类型
     * @return
     * @throws 用户已经注册时抛出DctException, code为{@link ErrorCode.USER_EXIST}
     */
     ...
     * @param memberDTO
     * @return
     * @throws 修改登录名为已注册登录名时抛出DctException, code为{@link ErrorCode.USER_EXIST}
     */
